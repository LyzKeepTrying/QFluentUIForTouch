...
QT_MOC_LITERAL(7, 103, 11), // "dateChanged"
QT_MOC_LITERAL(8, 115, 4), // "date"
QT_MOC_LITERAL(9, 120, 15), // "PlaceholderText"
QT_MOC_LITERAL(10, 136, 10), // "DateFormat"
QT_MOC_LITERAL(11, 147, 15), // "BackgroundColor"
QT_MOC_LITERAL(12, 163, 11), // "BorderColor"
QT_MOC_LITERAL(13, 175, 9), // "TextColor"
QT_MOC_LITERAL(14, 185, 12), // "PressedColor"
QT_MOC_LITERAL(15, 198, 8) // "FontSize"

    },
    "FluentDatePicker\0BackgroundColorChanged\0"
    "\0value\0BorderColorChanged\0TextColorChanged\0"
    "PressedColorChanged\0dateChanged\0date\0"
...
void FluentDatePicker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->dateChanged((*reinterpret_cast< const QDate(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FluentDatePicker::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FluentDatePicker::BackgroundColorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FluentDatePicker::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FluentDatePicker::BorderColorChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (FluentDatePicker::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FluentDatePicker::TextColorChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (FluentDatePicker::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FluentDatePicker::PressedColorChanged)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void FluentDatePicker::BackgroundColorChanged(QColor _t1)
{
...
// SIGNAL 1
void FluentDatePicker::BorderColorChanged(QColor _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void FluentDatePicker::TextColorChanged(QColor _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 3
void FluentDatePicker::PressedColorChanged(QColor _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
