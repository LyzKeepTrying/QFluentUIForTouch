...
QT_MOC_LITERAL(9, 121, 8) // "FontSize"

    },
    "FluentPushButton\0BackgroundColorChanged\0"
...
void FluentPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FluentPushButton::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FluentPushButton::BackgroundColorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (FluentPushButton::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FluentPushButton::BorderColorChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (FluentPushButton::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FluentPushButton::TextColorChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void FluentPushButton::BackgroundColorChanged(QColor _t1)
{
...
// SIGNAL 1
void FluentPushButton::BorderColorChanged(QColor _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void FluentPushButton::TextColorChanged(QColor _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
