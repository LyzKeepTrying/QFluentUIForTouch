...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        fluentToggleButton->setGeometry(QRect(170, 30, 71, 31));
        ...
        fluentToggleButton_2->setGeometry(QRect(270, 30, 71, 31));
        ...
        fluentGroupBox->setGeometry(QRect(10, 10, 361, 71));
        ...
        fluentGroupBox_2->setGeometry(QRect(10, 100, 361, 71));
        ...
        fluentPushButton->setGeometry(QRect(140, 15, 91, 41));
        QIcon icon;
        ...
        fluentGroupBox_3->setGeometry(QRect(10, 190, 361, 91));
        ...
        fluentIconPushButton_2->setGeometry(QRect(170, 15, 61, 61));
        ...
        fluentGroupBox_4->setGeometry(QRect(420, 10, 361, 91));
        ...
        fluentIconToggleButton_2->setGeometry(QRect(170, 0, 81, 81));
        ...
        fluentIconToggleButton->setGeometry(QRect(260, 10, 61, 61));
        ...
        fluentGroupBox_5->setGeometry(QRect(420, 110, 361, 71));
        ...
        fluentCircleSpinBox->setGeometry(QRect(160, 10, 141, 121));
        ...
        fluentCircleSpinBox_2->setGeometry(QRect(310, 10, 141, 121));
        ...
        fluentGroupBox_8->setGeometry(QRect(10, 470, 611, 261));
        ...
        fluentLineSpinBox_2->setGeometry(QRect(160, 60, 331, 51));
        ...
        fluentLineSpinBox->setGeometry(QRect(160, 150, 331, 51));
        ...
        fluentLineSpinBox_3->setGeometry(QRect(530, 10, 51, 251));
        ...
        fluentGroupBox_9->setGeometry(QRect(500, 310, 281, 91));
        ...
        fluentComboBox->setGeometry(QRect(110, 24, 141, 41));
        ...
        fluentGroupBox_10->setGeometry(QRect(10, 750, 491, 141));
        ...
        fluentProgressBar->setGeometry(QRect(140, 20, 331, 31));
        ...
        fluentProgressBar_2->setGeometry(QRect(140, 80, 331, 31));
        ...
        fluentGroupBox->raise();
        fluentToggleButton->raise();
        fluentToggleButton_2->raise();
        fluentGroupBox_2->raise();
        fluentGroupBox_3->raise();
        fluentGroupBox_4->raise();
        fluentGroupBox_5->raise();
        fluentGroupBox_6->raise();
        fluentGroupBox_7->raise();
        fluentGroupBox_8->raise();
        fluentGroupBox_9->raise();
        fluentGroupBox_10->raise();
