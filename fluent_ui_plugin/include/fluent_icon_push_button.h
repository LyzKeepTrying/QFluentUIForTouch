...
class Q_DECL_EXPORT FluentIconPushButton : public QPushButton {
    ...
    DECLARE_PROPERTY_COLOR(FluentIconPushButton, BackgroundColor, g_fluent_theme_center->getBackgroundColor())
    DECLARE_PROPERTY_COLOR(FluentIconPushButton, BorderColor, g_fluent_theme_center->getBorderColor())
    DECLARE_PROPERTY_COLOR(FluentIconPushButton, TextColor, g_fluent_theme_center->getTextColor())
